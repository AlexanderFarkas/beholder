...
Packages with other changes:
 ...
 - [`beholder` - `v0.4.2`](#beholder---v042)
 - [`beholder_flutter` - `v0.3.0+4`](#beholder_flutter---v0304)
 - [`beholder_provider` - `v0.0.3+17`](#beholder_provider---v00317)
 - [`beholder_form` - `v0.3.0+1`](#beholder_form---v0301)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `beholder_flutter` - `v0.3.0+4`
 - `beholder_provider` - `v0.0.3+17`
 - `beholder_form` - `v0.3.0+1`
...
Packages with other changes:
 ...
 - [`beholder_flutter` - `v0.3.0+3`](#beholder_flutter---v0303)
 - [`beholder_form` - `v0.2.1+3`](#beholder_form---v0213)
 - [`beholder_provider` - `v0.0.3+16`](#beholder_provider---v00316)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `beholder_provider` - `v0.0.3+16`

---

#### `beholder_flutter` - `v0.3.0+3`

 - **FIX**: allow validate to be optional.

#### `beholder_form` - `v0.2.1+3`
...
Packages with other changes:
 ...
 - [`beholder` - `v0.4.1+1`](#beholder---v0411)
 - [`beholder_flutter` - `v0.3.0+2`](#beholder_flutter---v0302)
 - [`beholder_provider` - `v0.0.3+15`](#beholder_provider---v00315)
 - [`beholder_form` - `v0.2.1+2`](#beholder_form---v0212)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `beholder_flutter` - `v0.3.0+2`
 - `beholder_provider` - `v0.0.3+15`
 - `beholder_form` - `v0.2.1+2`
...
Packages with other changes:
 ...
 - [`beholder` - `v0.4.1`](#beholder---v041)
 - [`beholder_flutter` - `v0.3.0+1`](#beholder_flutter---v0301)
 - [`beholder_provider` - `v0.0.3+14`](#beholder_provider---v00314)
 - [`beholder_form` - `v0.2.1+1`](#beholder_form---v0211)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `beholder_flutter` - `v0.3.0+1`
 - `beholder_provider` - `v0.0.3+14`
 - `beholder_form` - `v0.2.1+1`
...
Packages with breaking changes:
 ...
 - [`beholder` - `v0.4.0`](#beholder---v040)
 - [`beholder_flutter` - `v0.3.0`](#beholder_flutter---v030)

Packages with other changes:

 - [`beholder_provider` - `v0.0.3+13`](#beholder_provider---v00313)
 - [`beholder_form` - `v0.2.0+14`](#beholder_form---v02014)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `beholder_provider` - `v0.0.3+13`
 - `beholder_form` - `v0.2.0+14`
